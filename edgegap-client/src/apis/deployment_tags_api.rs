...
pub async fn deployments_tags_create(configuration: &configuration::Configuration, request_id: &str, payload: models::DeploymentTagPayload) -> Result<models::DeploymentTagResponse, Error<DeploymentsTagsCreateError>> {
...
pub async fn deployments_tags_list(configuration: &configuration::Configuration, request_id: &str) -> Result<models::DeploymentTagListResponse, Error<DeploymentsTagsListError>> {
    let local_var_configuration = configuration;
...
pub async fn deployments_tags_read(configuration: &configuration::Configuration, request_id: &str, tag_name: &str) -> Result<models::DeploymentTagResponse, Error<DeploymentsTagsReadError>> {
    let local_var_configuration = configuration;
...
pub async fn deployments_tags_update(configuration: &configuration::Configuration, request_id: &str, tag_name: &str, payload: models::DeploymentTagPayload) -> Result<models::DeploymentTagResponse, Error<DeploymentsTagsUpdateError>> {
    let local_var_configuration = configuration;
