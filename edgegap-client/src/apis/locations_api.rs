...
pub async fn location_beacon_list(configuration: &configuration::Configuration, ) -> Result<models::LocationBeaconList, Error<LocationBeaconListError>> {
...
pub async fn locations_get(configuration: &configuration::Configuration, app: Option<&str>, version: Option<&str>, r#type: Option<&str>, tags: Option<&str>) -> Result<models::Locations, Error<LocationsGetError>> {
    let local_var_configuration = configuration;
