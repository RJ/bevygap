...
pub async fn fleet_create(configuration: &configuration::Configuration, payload: models::FleetPostPayload) -> Result<models::FleetPostResponse, Error<FleetCreateError>> {
...
pub async fn fleet_delete(configuration: &configuration::Configuration, fleet_name: &str) -> Result<models::FleetDeleteResponse, Error<FleetDeleteError>> {
    let local_var_configuration = configuration;
...
pub async fn fleet_get(configuration: &configuration::Configuration, fleet_name: &str) -> Result<models::FleetGetResponse, Error<FleetGetError>> {
    let local_var_configuration = configuration;
...
pub async fn fleet_link_app_version(configuration: &configuration::Configuration, fleet_name: &str, app_name: &str, version_name: &str) -> Result<models::HorizontalScalerAppVersionLink, Error<FleetLinkAppVersionError>> {
    let local_var_configuration = configuration;
...
pub async fn fleet_policies_create(configuration: &configuration::Configuration, fleet_name: &str, payload: models::FleetPoliciesPostPayload) -> Result<models::FleetPoliciesPostResponse, Error<FleetPoliciesCreateError>> {
    let local_var_configuration = configuration;
...
pub async fn fleet_policies_get(configuration: &configuration::Configuration, fleet_name: &str, policy_name: &str) -> Result<models::FleetPoliciesGetResponse, Error<FleetPoliciesGetError>> {
    let local_var_configuration = configuration;
...
pub async fn fleet_policies_list(configuration: &configuration::Configuration, fleet_name: &str, page: Option<i32>, limit: Option<i32>, x_fields: Option<&str>) -> Result<models::HorizontalScalerConstraintList, Error<FleetPoliciesListError>> {
    let local_var_configuration = configuration;
...
pub async fn fleet_policies_update(configuration: &configuration::Configuration, fleet_name: &str, policy_name: &str, payload: models::FleetPoliciesPatchPayload) -> Result<models::FleetPoliciesPatchPayload, Error<FleetPoliciesUpdateError>> {
    let local_var_configuration = configuration;
...
pub async fn fleet_update(configuration: &configuration::Configuration, fleet_name: &str, payload: models::FleetPatchPayload) -> Result<models::FleetPatchResponse, Error<FleetUpdateError>> {
    let local_var_configuration = configuration;
...
pub async fn fleets(configuration: &configuration::Configuration, page: Option<i32>, limit: Option<i32>) -> Result<models::FleetList, Error<FleetsError>> {
    let local_var_configuration = configuration;
