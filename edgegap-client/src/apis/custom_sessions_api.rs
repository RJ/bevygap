...
pub async fn delete_custom_session(configuration: &configuration::Configuration, custom_id: &str, request_id: &str) -> Result<models::SessionDelete, Error<DeleteCustomSessionError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v1/deployment/{request_id}/custom/session/{custom_id}", local_var_configuration.base_path, custom_id=crate::apis::urlencode(custom_id), request_id=crate::apis::urlencode(request_id));
...
pub async fn delete_custom_sessions(configuration: &configuration::Configuration, request_id: &str, payload: models::CustomSessionDeleteModel) -> Result<models::BulkSessionDelete, Error<DeleteCustomSessionsError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v1/deployment/{request_id}/custom/sessions", local_var_configuration.base_path, request_id=crate::apis::urlencode(request_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
pub async fn get_custom_session(configuration: &configuration::Configuration, custom_id: &str, request_id: &str) -> Result<models::SessionGet, Error<GetCustomSessionError>> {
    let local_var_configuration = configuration;
...
pub async fn get_custom_sessions(configuration: &configuration::Configuration, request_id: &str) -> Result<models::Sessions, Error<GetCustomSessionsError>> {
    let local_var_configuration = configuration;
...
pub async fn patch_custom_session(configuration: &configuration::Configuration, custom_id: &str, request_id: &str, payload: models::CustomSessionModel) -> Result<models::SessionGet, Error<PatchCustomSessionError>> {
    let local_var_configuration = configuration;
...
pub async fn post_custom_session(configuration: &configuration::Configuration, custom_id: &str, request_id: &str, payload: models::CustomSessionModel) -> Result<models::SessionRequest, Error<PostCustomSessionError>> {
    let local_var_configuration = configuration;
...
pub async fn post_custom_sessions(configuration: &configuration::Configuration, request_id: &str, payload: models::CustomBulkSessionsModel) -> Result<models::BulkSessionPost, Error<PostCustomSessionsError>> {
    let local_var_configuration = configuration;
