...
pub async fn delete_users_session(configuration: &configuration::Configuration, session_id: &str, payload: models::PatchSessionModel) -> Result<models::SessionUserContext, Error<DeleteUsersSessionError>> {
...
pub async fn get_session(configuration: &configuration::Configuration, session_id: &str) -> Result<models::SessionGet, Error<GetSessionError>> {
    let local_var_configuration = configuration;
...
pub async fn get_users_session(configuration: &configuration::Configuration, session_id: &str) -> Result<models::SessionUserContext, Error<GetUsersSessionError>> {
    let local_var_configuration = configuration;
...
pub async fn put_users_session(configuration: &configuration::Configuration, session_id: &str, payload: models::PatchSessionModel) -> Result<models::SessionUserContext, Error<PutUsersSessionError>> {
    let local_var_configuration = configuration;
...
pub async fn session_delete(configuration: &configuration::Configuration, session_id: &str) -> Result<models::SessionDelete, Error<SessionDeleteError>> {
    let local_var_configuration = configuration;
...
pub async fn session_post(configuration: &configuration::Configuration, payload: models::SessionModel) -> Result<models::SessionRequest, Error<SessionPostError>> {
    let local_var_configuration = configuration;
...
pub async fn sessions_bulk_stop(configuration: &configuration::Configuration, payload: models::SessionBulkStopPayload) -> Result<models::SessionBulkStopResponse, Error<SessionsBulkStopError>> {
    let local_var_configuration = configuration;
