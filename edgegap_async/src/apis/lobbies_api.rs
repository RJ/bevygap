...
pub async fn lobby_create(configuration: &configuration::Configuration, payload: models::LobbyCreatePayload) -> Result<models::LobbyReadResponse, Error<LobbyCreateError>> {
...
pub async fn lobby_delete(configuration: &configuration::Configuration, lobby_name: &str) -> Result<models::LobbyReadResponse, Error<LobbyDeleteError>> {
    let local_var_configuration = configuration;
...
pub async fn lobby_deploy(configuration: &configuration::Configuration, payload: models::LobbyDeployPayload) -> Result<models::LobbyReadResponse, Error<LobbyDeployError>> {
    let local_var_configuration = configuration;
...
/// Get a named lobby.
pub async fn lobby_get(configuration: &configuration::Configuration, lobby_name: &str) -> Result<models::LobbyReadResponse, Error<LobbyGetError>> {
    let local_var_configuration = configuration;
...
/// List the Lobbies
pub async fn lobby_list(configuration: &configuration::Configuration, ) -> Result<models::LobbyReadResponse, Error<LobbyListError>> {
    let local_var_configuration = configuration;
...
pub async fn lobby_terminate(configuration: &configuration::Configuration, payload: models::LobbyTerminatePayload) -> Result<models::LobbyReadResponse, Error<LobbyTerminateError>> {
    let local_var_configuration = configuration;
