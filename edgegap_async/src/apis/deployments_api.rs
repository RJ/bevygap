...
pub async fn deployments_available(configuration: &configuration::Configuration, payload: models::DeploymentAvailablePayload) -> Result<models::DeploymentAvailableResponse, Error<DeploymentsAvailableError>> {
    let local_var_configuration = configuration;
...
pub async fn deployments_get(configuration: &configuration::Configuration, query: Option<&str>) -> Result<models::Deployments, Error<DeploymentsGetError>> {
    let local_var_configuration = configuration;
